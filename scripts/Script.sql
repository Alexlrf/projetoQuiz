...
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, id_DISCIPLINA, SENHA, TIPO, ATIVO) 
	VALUES ('VILMAR', '2222222', '22222222222', '2020-05-05', 'M', false, '45987456321', 'MATUTINO', 1, 'vilmar', 'PROFESSOR', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, id_DISCIPLINA, SENHA, TIPO, ATIVO) 
	VALUES ('ADRIANO', '4444444', '44444444444', '2020-05-05', 'M', false, '45987456321', 'MATUTINO', 1, 'adriano', 'PROFESSOR', true); 
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, id_DISCIPLINA, SENHA, TIPO, ATIVO) 
...
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('KOGUT', '1111111', '11111111111', '2020-05-05', 'M', false, '45987456311', 'MATUTINO', 'kogut', 'COORDENADOR', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('JOÃO', '5656565', '56565656565', '2020-05-05', 'M', false, '45987456351', 'NOTURNO', 'joao', 'COORDENADOR', true);

INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('ALISON', '3333333', '33333333333', '2020-05-05', 'M', false, '45987456321', 'MATUTINO', 'alison', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('RODRIGO', '6666666', '66666666666', '2020-04-05', 'M', false, '45987456321', 'NOTURNO', 'rodrigo', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('ALEXANDRO', '7777777', '77777777777', '2020-03-05', 'M', false, '45987456551', 'MATUTINO', 'alexandro', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('ANA CAROLINA', '8888888', '88888888888', '2020-02-05', 'F', false, '45987456521', 'NOTURNO', 'carolina', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('PELÉ', '9999999', '99999999999', '2020-01-05', 'M', false, '45987956321', 'MATUTINO', 'pele', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO) 
	VALUES ('WAGNER', '1010101', '10101010101', '2020-10-05', 'M', false, '44983456321', 'NOTURNO', 'wagner', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('PATETA', '1313131', '13131313131', '2020-05-05', 'M', false, '48987456321', 'MATUTINO', 'pateta', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('TOM', '3131313', '31313131313', '2020-05-05', 'M', false, '47987456321', 'MATUTINO', 'tom', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('WILL', '5151515', '51515151515', '2020-05-05', 'M', false, '46987456321', 'MATUTINO', 'will', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('JASON', '1919191', '19191919191', '2020-05-05', 'M', false, '42987456321', 'MATUTINO', 'jason', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('HEITOR', '9191919', '91919191919', '2020-05-05', 'M', false, '45777456321', 'MATUTINO', 'heitor', 'ALUNO', true);
INSERT INTO USUARIO (NOME, RG,  CPF, DT_NASCIMENTO, SEXO, POSSUI_DEFICIENCIA, CELULAR, TURNO, SENHA, TIPO, ATIVO)
	VALUES ('CELSO', '1717171', '17171717171', '2020-05-05', 'M', false, '45988456321', 'MATUTINO', 'celso', 'ALUNO', true);
